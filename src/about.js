    ...
    return (
        <div className="about-me">
            <div className="about-me-paragraphs">
                <p>Thanks for taking the time to look through my site! My name is Shivam Patel and I'm a software engineer with a passion for building beautiful products that live on the internet. 
                    I graduated from UC Berkeley in 2019, and have been working to improve my skills ever since. Most recently, I spent my as a founding engineer for <a href="https://unifai.us" target="_blank">Unifai</a>  My main focus these days is building accessible, inclusive products and continuing to build my portfolio. </p>
